#!/usr/bin/env python3
"""
Script para actualizar ai_service.py con el chatbot avanzado
"""
...
# Nuevo método chatbot_response con todos los métodos auxiliares
new_chatbot_code = '''    # ==========================================
...
# Buscar y reemplazar el método chatbot_response completo
pattern = r'(    # ={40,}\n    # FUNCIONALIDAD 1: CHATBOT\n    # ={40,}\n\n    def chatbot_response.*?)(    # ={40,}\n    # FUNCIONALIDAD 2:)'

replacement = new_chatbot_code + '\n\n\\2'
...
print("✅ Archivo ai_service.py actualizado exitosamente")
print("✅ Chatbot avanzado con detección de intención implementado")
print("✅ 6 métodos auxiliares agregados")
